...
SUBROUTINE FUNC (JLON_, JLEV_, JFLD_, JBLK_, PCOEF_, ZZ)
...
ZZ = REAL (JLON_, JPRD) + 100._JPRD * (REAL (JLEV_, JPRD) + 100._JPRD * &
...
DO JBLK = 1, NGPBLKS
  ...
  DO JFLD = 1, NDIM
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZPTR3 (JLON, JLEV, JFLD))
      ENDDO
    ENDDO
  ENDDO
ENDDO
...
DO JBLK = 1, NGPBLKS
  ...
  DO JFLD = 1, NDIM
   DO JLEV = 0, NFLEVG
     DO JLON = 1, NPROMA
       CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZFUNC)
       IF (ZPTR3 (JLON, JLEV, JFLD) /= ZFUNC) THEN
...
DO JBLK = 1, NGPBLKS
  DO JDIM = 1, SIZE (KFLD)
    ...
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZPTR2 (JLON, JLEV))
      ENDDO
    ENDDO
  ENDDO
ENDDO
...
DO JBLK = 1, NGPBLKS
  DO JFLD = 1, NDIM
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZHOST4 (JLON, JLEV, JFLD, JBLK))
      ENDDO
    ENDDO
  ENDDO
ENDDO
...
DO JBLK = 1, NGPBLKS
  DO JFLD = 1, NDIM
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZDEVICE4 (JLON, JLEV, JFLD, JBLK))
      ENDDO
    ENDDO
  ENDDO
ENDDO
...
DO JBLK = 1, NGPBLKS
  DO JFLD = 1, NDIM
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZFUNC)
        IF (ZHOST4 (JLON, JLEV, JFLD, JBLK) /= ZFUNC) THEN
...
DO JBLK = 1, NGPBLKS
  DO JFLD = 1, NDIM
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZFUNC)
        IF (ZDEVICE4 (JLON, JLEV, JFLD, JBLK) /= ZFUNC) THEN
...
DO JDIM = 1, SIZE (KFLD)
  ...
  DO JBLK = 1, NGPBLKS
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZHOST3 (JLON, JLEV, JBLK))
      ENDDO
    ENDDO
  ENDDO
...
!$acc serial present (ZDEVICE3) 
  ...
  DO JBLK = 1, NGPBLKS
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZDEVICE3 (JLON, JLEV, JBLK))
      ENDDO
    ENDDO
  ENDDO
...
COMMON / COMDEBUG / LDEBUG; LOGICAL :: LDEBUG
...
!$acc serial present (ZDEVICE3) 
  ...
  DO JBLK = 1, NGPBLKS
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZFUNC)
        IF (ZDEVICE3 (JLON, JLEV, JBLK) /= ZFUNC) THEN
          PRINT *, JLON, JLEV, JFLD, JBLK
...
DO JDIM = 1, SIZE (KFLD)
  ...
  DO JBLK = 1, NGPBLKS
    DO JLEV = 0, NFLEVG
      DO JLON = 1, NPROMA
        CALL FUNC (JLON, JLEV, JFLD, JBLK, ZCOEF, ZFUNC)
        IF (ZHOST3 (JLON, JLEV, JBLK) /= ZFUNC) THEN
...
DO JFLD = 1, NDIM
  IF (YLF4%GET_STATUS () /= YLF3L(JFLD)%PTR%GET_STATUS ()) THEN
    PRINT *, JFLD
    WRITE (0, '("YLF4 = ",Z16.16)') YLF4%GET_STATUS ()
    WRITE (0, '("YLF3L (",I0,")=",Z16.16)') JFLD, YLF3L(JFLD)%PTR%GET_STATUS ()
...
IF (LLVERBOSE) THEN
  ...
  IF (PRESENT (KFLD)) THEN
    WRITE (0, '("(")', ADVANCE='NO')
    DO JDIM = 1, SIZE (KFLD)
      WRITE (0, '(I0)', ADVANCE='NO') KFLD (JDIM)
      
      IF (JDIM < SIZE (KFLD)) WRITE (0, '(",")', ADVANCE='NO')
    ENDDO
    WRITE (0, '(")")', ADVANCE='NO')
  ENDIF
