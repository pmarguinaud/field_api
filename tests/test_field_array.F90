...
PROGRAM TEST_FIELD_ARRAY
        ! TEST FIELD_ARRAY WRAPPER/OWNER
        ...
        CALL W%INIT (UBOUNDS=[10,2], PERSISTENT=.TRUE.)
        IF (.NOT. SIZE(W%F_P%PTR) == 20) THEN
           CALL FIELD_ABORT ("FIELD_ARRAY_OWNER NOT INITIALISED CORRECTLY")
        END IF
